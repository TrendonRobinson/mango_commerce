...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    first = models.CharField(max_length=30, unique=False, default='')
    last = models.CharField(max_length=30, unique=False, default='')
    date_joined = models.DateTimeField(
        verbose_name="date joined", default=datetime.datetime.now)
